...
MOCK_SUMMARY =  {'summary': ' Customer Name: CID-982305. \xa0Purchase Order. Buyer Name: 1234 Oak Street, Suite 400, Springfield, IL, 62704 . Phone: (312 555-7890 (555-876-5432) Email: janedoe@company.com.com .'}

MOCK_ENTITIES = {
    "date": [{"label": "date", "text": "10/05/2023", "start": 17, "end": 27}],
    "customer_id": [{"label": "customer_id", "text": "CID-982305", "start": 56, "end": 66}],
    "address": [{"label": "address", "text": "1234 Oak Street, Suite 400, Springfield, IL, 62704", "start": 82, "end": 140}],
    "phone_number": [
        {"label": "phone_number", "text": "(312) 555-7890", "start": 149, "end": 162},
        {"label": "phone_number", "text": "555-876-5432", "start": 164, "end": 176}
    ],
    "email": [{"label": "email", "text": "janedoe@company.com", "start": 185, "end": 204}]
}
...
class MockGLiNER:
    ...
    def predict_entities(self, text, labels, threshold):
        return [
            ...
            {"label": "address", "text": "1234 Oak Street, Suite 400, Springfield, IL, 62704", "start": 82, "end": 140},
            {"label": "phone_number", "text": "(312) 555-7890", "start": 149, "end": 162},
            {"label": "phone_number", "text": "555-876-5432", "start": 164, "end": 176},
